  ...
  if (locale === "en") {
    return {
      ...
      openGraph: {
        title: "Wikolabs — AI Agents, Data & Automation for Businesses",
        description:
          "AI agents, Data Engineering, Automation, Fullstack Development. Concrete solutions that transform your operations — no technical jargon.",
        type: "website",
        locale: "en_US",
        url: BASE_URL,
        siteName: "Wikolabs",
