...
type Tech = { e: string; n: string };

const CATEGORY_TECHS: Tech[][][] = [
  [
    [{ e: "🔗", n: "LangGraph" }, { e: "🐍", n: "Python" }, { e: "🔄", n: "n8n" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🦜", n: "LangChain" }, { e: "🐍", n: "Python" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🔄", n: "n8n" }, { e: "🐍", n: "Python" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🐍", n: "Python" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🚀", n: "FastAPI" }, { e: "🐍", n: "Python" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🚀", n: "FastAPI" }, { e: "🐍", n: "Python" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🔄", n: "n8n" }, { e: "🐍", n: "Python" }],
  ],
  [
    [{ e: "🦜", n: "LangChain" }, { e: "🔗", n: "LangGraph" }, { e: "🚀", n: "FastAPI" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🐍", n: "Python" }],
    [{ e: "🔄", n: "n8n" }, { e: "🐍", n: "Python" }],
    [{ e: "🐍", n: "Python" }, { e: "🦜", n: "LangChain" }],
  ],
  [
    [{ e: "📦", n: "BigQuery" }, { e: "🔗", n: "LangGraph" }, { e: "🐍", n: "Python" }],
    [{ e: "🐍", n: "Python" }, { e: "📦", n: "BigQuery" }],
    [{ e: "📊", n: "Scikit-learn" }, { e: "🧠", n: "TensorFlow" }, { e: "🐍", n: "Python" }],
    [{ e: "🔗", n: "LangGraph" }, { e: "🐍", n: "Python" }],
  ],
  [
    [{ e: "🐍", n: "Python" }, { e: "🚀", n: "FastAPI" }, { e: "🔍", n: "Elastic" }],
    [{ e: "🧠", n: "TensorFlow" }, { e: "🐍", n: "Python" }],
    [{ e: "🐍", n: "Python" }, { e: "📦", n: "BigQuery" }, { e: "🌊", n: "Dataflow" }],
    [{ e: "🔥", n: "PyTorch" }, { e: "🧠", n: "TensorFlow" }, { e: "🐍", n: "Python" }],
  ],
  [
    [{ e: "🐍", n: "Python" }, { e: "🔗", n: "LangGraph" }],
    [{ e: "🔥", n: "PyTorch" }, { e: "🐍", n: "Python" }],
    [{ e: "🐍", n: "Python" }],
    [{ e: "🐍", n: "Python" }, { e: "☁️", n: "GCP" }],
  ],
];
  ...
  fr: {
    ...
    services: [
      ...
      },
      {
        ...
        desc: "Du sourcing à l'onboarding : génération de leads, enrichissement BANT, outreach multicanal, qualification, setting, proposition, closing, support et rétention. Routage intelligent à chaque étape.",
  ...
  en: {
    ...
    services: [
      ...
      },
      {
        ...
        desc: "From sourcing to onboarding: lead generation, BANT enrichment, multichannel outreach, qualification, appointment setting, proposal, closing, support and retention. Intelligent routing at every stage.",
                ...
                {cat.offers.map((offer, oi) => (
                  <div key={oi} className={styles.offerCard}>
                    ...
                    <div className={styles.offerTechs}>
                      {(CATEGORY_TECHS[ci]?.[oi] ?? []).map((tech, ti) => (
                        <span key={ti} className={styles.offerTech}>
                          <span>{tech.e}</span>
                          {tech.n}
                        </span>
                      ))}
