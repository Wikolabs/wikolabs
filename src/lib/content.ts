...
const DEFAULTS_FR: SiteContent = {
  ...
  roles: [
    ...
    { emoji: "⚡", title: "Fullstack Developer", desc: "Applications web complètes. React/Vue + Node.js/Python + SQL/NoSQL. Le profil le plus demandé.", tjm: "270 – 490 EUR/jour" },
  ...
  pricing: [
    ...
    { role: "Fullstack Dev", junior: "270 €", confirmed: "375 €", senior: "490 €" },
...
const DEFAULTS_EN: SiteContent = {
  ...
  roles: [
    ...
    { emoji: "⚡", title: "Fullstack Developer", desc: "Complete web applications. React/Vue + Node.js/Python + SQL/NoSQL. The most in-demand profile.", tjm: "270 – 490 EUR/day" },
